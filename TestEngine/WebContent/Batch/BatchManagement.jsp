...
<title>CETEST-Batch Management</title>
</head>
<body>
	<div class="wrap">
	<header id="header">
	...
	<%@ include file="/menu.jsp" %>
		...
		<div class="topContent">
		 	...
		 	<div class="topNav_middle">
		 		<span class="view-fieldsetValue">Enter Batch Name/Id to Search</span> &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="searchparam" style="width: 300px"><input type="submit" value="Search">&nbsp;&nbsp; <span class="view-fieldsetValue">Total Count : ${requestScope.totalRecords}</span>
		 	</div>
		 	<div class="clear"></div>
	...
	<div class="Cimm-Column-Wrap">
		<div class="leftContent responsiveLeftCol"> 
				<div class="Cimm-ColumnLeft-Content cimm_boxShadow leftSliderPop">
					...
					<%@ include file="/Batch/BatchManagementLeftMenu.jsp" %>
					</div>
					</div>
					</div>
				</div>
		...
		<%@ include file="/Batch/ListBatches.jsp" %>
		...
		<div class="Cimm-ColumnRight-Content cimm_boxShadow rightSliderPop">
			<div class="cimmRightSliderContent">
				...
				<c:choose>
					...
					<c:otherwise>
						<%@ include file="/Batch/CreateBatch.jsp" %>
					</c:otherwise>
					</c:choose>
				</div>
			</div>
